...
const conditions = [
  {
    text: "Được điều động vào lực lượng vũ trang",
    details:
      "Phải có quyết định điều động chính thức từ cơ quan có thẩm quyền.",
  },
  {
    text: "Lý do sức khỏe",
    details:
      "Bị ốm, tai nạn phải điều trị thời gian dài (có giấy xác nhận của bệnh viện cấp Quận/Huyện trở lên).",
  },
  {
    text: "Lý do cá nhân khác",
    details:
...
const requiredFiles = [
  {
    text: "Đơn xin bảo lưu",
    href: "/bieu-mau/don-xin-bao-luu.docx",
    downloadName: "don-xin-bao-luu.docx",
    downloadable: true,
  },
  {
    text: "Giấy tờ minh chứng lý do",
    downloadable: false,
  },
];

export default function RetentionInfoPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 text-lg text-slate-600 max-w-3xl">
            Thủ tục cho phép sinh viên tạm dừng việc học tại trường trong một
            khoảng thời gian nhất định và bảo lưu các kết quả học tập đã đạt
            được để tiếp tục theo học sau này.
          </p>
        </motion.div>
            ...
            <MotionDiv index={1}>
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <p className="text-sm text-slate-500 mb-5">
                  (sinh viên được bảo lưu nếu đáp ứng 1 trong 3 điều kiện dưới
                  đây)
                </p>
                    ...
                    >
                      ...
                      {file.downloadable && file.href && file.downloadName ? (
                        <a
                          ...
                          aria-label={`Tải xuống ${file.text}`}
                        ...
                        <span
                          ...
                          title="Tài liệu minh chứng theo lý do bảo lưu"
                        >
