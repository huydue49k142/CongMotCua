...
const services = [
  { 
    href: '/student/student-procedure-info/major-change', 
    label: 'Chuyển ngành', 
    icon: ArrowRightLeft,
  },
  { 
    href: '/student/student-procedure-info/dropout', 
    label: 'Thôi học', 
    icon: BookCopy,
  },
  { 
    href: '/student/student-procedure-info/retention', 
    label: 'Bảo lưu', 
    icon: Archive,
  },
  { 
    href: '/student/student-procedure-info/resume', 
    label: 'Học tiếp', 
    icon: PlayCircle,
  },
];
