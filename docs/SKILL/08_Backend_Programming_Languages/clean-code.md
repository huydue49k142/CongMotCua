---
name: clean-code
description: "Principles of Clean Code by Robert C. Martin (Uncle Bob). Transform code that works into code that is clean, readable, and maintainable."
risk: safe
...
Principles of Clean Code by Robert C. Martin (Uncle Bob). Transform code that works into code that is clean.
...
## 3. Comments
- **Don't Comment Bad Code—Rewrite It**: Most comments are a sign of failure
...
- **Bad Comments**: Mumbling, Redundant, Misleading, Mandated, Noise
